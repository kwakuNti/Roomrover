    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            for ($slotNumber = 1; $slotNumber <= $capacity; $slotNumber++) {
                ...
                echo '
                <div class="info">
                    <a href="../actions/room_selection_2d.php?roomID=' . htmlspecialchars($roomID) . '&slotNumber=' . htmlspecialchars($slotNumber) . '" class="button return no-underline" aria-hidden="true">'
