                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H1 is a two-in-a-room that shares a corridor and a bathroom with H2.
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H2 is a two-in-a-room that shares a corridor and a bathroom with H1.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H3 is a two-in-a-room that shares a corridor and a bathroom with H4.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card3" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H4 is a two-in-a-room that shares a corridor and a bathroom with H3.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card4" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H5 is a two-in-a-room that shares a corridor and a bathroom with H6.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card5" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H6 is a two-in-a-room that shares a corridor and a bathroom with H5.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card6" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H7 is a two-in-a-room that shares a corridor and a bathroom with H8.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card7" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H8 is a two-in-a-room that shares a corridor and a bathroom with H7.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card8" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H9 is a two-in-a-room that shares a corridor and a bathroom with H10.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card9" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H10 is a two-in-a-room that shares a corridor and a bathroom with H9.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card10" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H11 is a two-in-a-room that shares a corridor and a bathroom with H12.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card11" class="button return" aria-hidden="true">
            ...
            <div class="front" style="background-image: url('../templates/img/banner/banner.png');">
                ...
                <div class="back">
                    <div class="inner">
                        ...
                        <div class="description">
                            <p> H12 is a two-in-a-room that shares a corridor and a bathroom with H11.
                            The rooms available take either 2 or 4 occupants.
                            All rooms that take 2 occupants are two times smaller than rooms that take 4 occupants.</p>
                        </div>
                        <label for="card12" class="button return" aria-hidden="true">
